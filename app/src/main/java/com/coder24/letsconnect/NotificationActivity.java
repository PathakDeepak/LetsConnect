...
public class NotificationActivity extends AppCompatActivity {
    ...
    private RecyclerView notificationLists;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        notificationLists = findViewById(R.id.notification_lists);
        notificationLists.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
    }
